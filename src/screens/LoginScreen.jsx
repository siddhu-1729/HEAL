      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputWrap}>
            ...
            <TextInput style={styles.input} placeholder="Enter your password" placeholderTextColor={COLORS.textMuted}
              secureTextEntry={secure} value={password} onChangeText={setPassword} />
            <TouchableOpacity onPress={() => setSecure(s => !s)} style={styles.showBtn}>
              <Text style={styles.showTxt}>{secure ? 'Show' : 'Hide'}</Text>
            </TouchableOpacity>
          </View>

          <TouchableOpacity style={styles.forgotRow} onPress={() => Alert.alert('Reset', 'Password reset coming soon!')}>
            <Text style={styles.forgotTxt}>Forgot password?</Text>
          </TouchableOpacity>

          {/* Sign In */}
          <TouchableOpacity style={[styles.primaryBtn, loading && styles.btnLoading]}
          ...
          {/* Google */}
          <TouchableOpacity style={styles.socialBtn} onPress={handleGoogleSignIn} disabled={loading} activeOpacity={0.85}>
...
const styles = StyleSheet.create({
  ...
  inputWrap: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.surfaceAlt, borderRadius: RADIUS.md, borderWidth: 1.5, borderColor: COLORS.border, marginBottom: SPACING.lg, paddingHorizontal: SPACING.md },
  ...
  primaryBtn: { backgroundColor: COLORS.primary, borderRadius: RADIUS.md, paddingVertical: SPACING.lg, alignItems: 'center', ...SHADOW.md },
  ...
  socialBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: COLORS.border, borderRadius: RADIUS.md, paddingVertical: SPACING.md, backgroundColor: COLORS.surface, ...SHADOW.sm },
